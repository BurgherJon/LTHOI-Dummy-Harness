...
public final class GameCollection extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public GameCollection set(String fieldName, Object value) {
    return (GameCollection) super.set(fieldName, value);
  }

  @Override
  public GameCollection clone() {
    return (GameCollection) super.clone();
  }
